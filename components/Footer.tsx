        ...
        <footer className="bg-black/40 backdrop-blur-lg mt-0">
            <div className="container mx-auto px-6 py-12 text-center">
                ...
                <div className="flex justify-center space-x-6 mb-8">
                    ...
                    <a href="mailto:mason@sonofma.com" target="_blank" rel="noopener noreferrer" aria-label="Email Son of Ma" className="text-white hover:text-cyan-300 transition-all duration-300 transform hover:scale-125">
